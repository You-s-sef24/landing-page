...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 grid grid-cols-2 md:grid-cols-3 items-center bg-white font-bold text-purple-600 p-3 z-50 border-b border-gray-200 dark:border-neutral-700 shadow-lg">
      <h3 className="text-2xl">Teqneia</h3>
      ...
      {isOpen && (
        <div className="md:hidden fixed top-16 left-0 w-screen bg-purple-950/50 border-t border-gray-200 dark:border-neutral-700 shadow-lg z-50">
          <a
            href="#home"
            className="block px-6 py-4 text-white hover:bg-purple-950"
